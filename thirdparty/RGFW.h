...
rgfw_c.#define RGFW_NO_DPI - do not calculate DPI and don't use libShcore (win32)
...
RGFWDEF void* RGFW_window_getHINSTANCE();
...
void* RGFW_window_getHINSTANCE() { return _RGFW->instance; }
